...
START TRANSACTION;
USE `mutrack_simple`;
INSERT INTO `mutrack_simple`.`tb_permission` (`pk_id`, `role`) VALUES (1, 'ROLE_ADMIN');
INSERT INTO `mutrack_simple`.`tb_permission` (`pk_id`, `role`) VALUES (2, 'ROLE_USER');
...
-- Table `mutrack_simple`.`tb_user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mutrack_simple`.`tb_formulario` ;

CREATE TABLE IF NOT EXISTS `mutrack_simple`.`tb_formulario` (
  `pk_id` INT NOT NULL AUTO_INCREMENT,  
  `email` VARCHAR(255) NOT NULL,
  `name` VARCHAR(60) NOT NULL,
...
-- Table `mutrack_simple`.`tb_user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mutrack_simple`.`tb_file` ;

CREATE TABLE IF NOT EXISTS `mutrack_simple`.`tb_file` (
